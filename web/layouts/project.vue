...
// SVG icons as render functions (avoids creating separate component files for 2 icons)
...
// Desktop sidebar surfaces Resumen at the bottom (less frequent than day-to-day gastos work).
