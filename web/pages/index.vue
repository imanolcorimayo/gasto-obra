<template>
  <div class="bg-go-bg min-h-screen">
    ...
    <!-- ═══ TIPOS DE REGISTRO ═══ -->
    <section id="tipos-de-registro" class="py-20 sm:py-28 border-t border-go-border-subtle">
      <div class="max-w-6xl mx-auto px-5">
        <div ref="typesRef" class="text-center mb-12 landing-fade-up">
          <p class="text-go-primary text-sm font-medium tracking-wide uppercase mb-3">Tipos de registro</p>
          <h2 class="font-display text-2xl sm:text-3xl text-go-text">
            Tres movimientos, una sola herramienta
          </h2>
        </div>
        ...
        <div ref="typesCardsRef" class="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div class="bg-go-surface border border-go-border rounded-go-xl p-6 landing-fade-up">
            ...
            <h3 class="font-display text-go-text text-lg mb-2">Gasto de obra</h3>
            <p class="text-go-text-secondary text-sm leading-relaxed mb-3">
              Materiales, herramientas, transporte — lo que comprás para la obra. Se descuenta del presupuesto del cliente.
            </p>
            <div class="bg-go-bg/60 rounded-go-md px-3 py-2 text-xs text-go-text-tertiary italic">
              "500 clavos en la ferretería"
            </div>
          </div>
          ...
          <div class="bg-go-surface border border-go-border rounded-go-xl p-6 landing-fade-up landing-delay-100">
            ...
            <h3 class="font-display text-go-text text-lg mb-2">Pago del cliente</h3>
            <p class="text-go-text-secondary text-sm leading-relaxed mb-3">
              Cuando el cliente te transfiere o te da plata. Se suma al balance a favor y reduce lo que te debe.
            </p>
            <div class="bg-go-bg/60 rounded-go-md px-3 py-2 text-xs text-go-text-tertiary italic">
          ...
          <!-- Gasto propio -->
          <div class="bg-go-surface border border-go-border rounded-go-xl p-6 landing-fade-up landing-delay-200">
            ...
            <h3 class="font-display text-go-text text-lg mb-2">Gasto propio</h3>
            <p class="text-go-text-secondary text-sm leading-relaxed mb-3">
              Tu almuerzo, tu nafta, tus herramientas personales. Se registra separado para que no se mezcle con lo del cliente.
            </p>
            <div class="bg-go-bg/60 rounded-go-md px-3 py-2 text-xs text-go-text-tertiary italic">
...
onMounted(async () => {
  ...
  [typesRef, typesCardsRef, featuresRef, whatsappTitleRef, whatsappRef, clientRef, howRef, stepsRef, whyTitleRef, whyRef, contactRef, ctaRef].forEach((ref) => {
